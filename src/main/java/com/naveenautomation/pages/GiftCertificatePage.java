...
public class GiftCertificatePage extends TestBase {
	...
	@FindBy(css = "a[href='https://naveenautomationlabs.com/opencart/index.php?route=account/voucher']")
	...
	public void submitGiftcertificate(String recipientName, String recipientEmail, String name, String email, String message, String amount) {
